...
public abstract class Eveniment {
    ...
    public Eveniment(int duration_h, int duration_m, double price,int locuri,int id) {
        this.duration_h = duration_h;
        this.duration_m = duration_m;
        this.price = price;
        this.locuri=locuri;
    ...
    public String toString() {
        return "Eveniment{" + "dureaza = " + duration_h +" ore  si " + duration_m + " minute " + "; pretul este de " + price + " lei si sunt disponibile "+locuri+" locuri "+'}';
    }
}
